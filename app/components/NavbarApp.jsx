...
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, useDisclosure, Button, Checkbox, Input, DatePicker, Textarea } from "@nextui-org/react";
    ...
    <>
      ...
      >
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">Creando Oferta para Transportación</ModalHeader>
              <ModalBody>
                <div className="grid lg:grid-cols-2 gap-4">
                  <Input className="lg:col-span-2" type="text" label="Mercancía a transportar" />
                  <Input type="number" label="Peso aprox. en Kgs" />
                  <Input type="number" label="Volumen aprox. en m3" />
                  <Input type="number" label="Precio de oferta" color="success" />
                  <DatePicker label="Fecha de Transportación" className="max-w-[284px]" />
